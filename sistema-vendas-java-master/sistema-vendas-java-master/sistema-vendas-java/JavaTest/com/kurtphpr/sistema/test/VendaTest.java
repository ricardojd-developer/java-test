...
public class VendaTest extends TestHeranca {
	...
	public void setup() {
		...
		c1 = new Cliente("21244634700", "teste1@mail.com", "Rua 1", "Cliente 1", new Date(), 1000);
		c2 = new Cliente("21244634700", "teste2@mail.com", "Rua 2", "Cliente 2", new Date(), 2000);
		c3 = new Cliente("21244634700", "teste3@mail.com", "Rua 3", "Cliente 3", new Date(), 3000);
